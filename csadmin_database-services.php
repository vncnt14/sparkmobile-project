...
$query1 = "SELECT servicedone.*, servicedone.services, carowners.user_id, carowners.firstname, carowners.lastname, carowners.contact, servicedone.status
           FROM servicedone
            ...
            <div class="row">
                ...
                if (mysqli_num_rows($result1) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result1)) {
                        ...
                        echo '<td>';
                        echo '<form action="csservice-delete.php" method="POST">';
