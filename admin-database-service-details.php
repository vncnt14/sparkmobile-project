...
$finish_query = "SELECT users.firstname, users.lastname, service_details.product_name, service_details.service,
service_details.selected_id
...
<body>
    ...
    <main class="container-table mt-5 text-dark">
        ...
        <div class="row">
            ...
            // Execute the query
            $finish_query = "SELECT users.firstname, users.lastname, service_details.product_name, service_details.service,
    service_details.selected_id, service_details.price
    FROM service_details
    LEFT JOIN users ON users.user_id = service_details.user_id";
            $finish_result = mysqli_query($connection, $finish_query);
            ...
            if (mysqli_num_rows($finish_result) > 0) {
                ...
                while ($serviceData = mysqli_fetch_assoc($finish_result)) {
                    ...
                    echo '<td>' . htmlspecialchars($serviceData['price']) . '</td>';
